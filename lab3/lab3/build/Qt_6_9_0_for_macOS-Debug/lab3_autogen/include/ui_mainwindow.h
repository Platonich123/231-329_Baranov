...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        get_1->setGeometry(QRect(190, 140, 341, 51));
        get_all = new QPushButton(centralwidget);
        get_all->setObjectName("get_all");
        get_all->setGeometry(QRect(190, 70, 341, 51));
        update = new QPushButton(centralwidget);
        update->setObjectName("update");
        update->setGeometry(QRect(190, 270, 341, 51));
        ...
        delete_2->setGeometry(QRect(190, 340, 341, 51));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        get_1->setText(QCoreApplication::translate("MainWindow", "get", nullptr));
